...
//    currentDefenceModePressed = defenseModeButton.get();
    ...
    private void output() {
        ...
        waltonDashboard.getEntry(MOTORS_STATE).setString(stateMachine.getCurrentState().getClass().getSimpleName());
        waltonDashboard.getEntry(MOTORS_ELEVATOR_HEIGHT).setNumber(elevator.getElevatorHeight());
        waltonDashboard.getEntry(MOTORS_ELEVATOR_POWER).setNumber(elevator.getElevatorPower());
        waltonDashboard.getEntry(MOTORS_ELEVATOR_TARGET).setNumber(elevator.getCurrentTarget());
        waltonDashboard.getEntry(MOTORS_ELEVATOR_MODE).setString(elevator.getControlMode().name());

        waltonDashboard.getEntry(MOTORS_HATCH_ANGLE).setNumber(hatch.getAngle());
        waltonDashboard.getEntry(MOTORS_HATCH_POWER).setNumber(hatch.getRotationPower());
        waltonDashboard.getEntry(MOTORS_HATCH_TARGET).setNumber(hatch.getCurrentTarget());
        waltonDashboard.getEntry(MOTORS_HATCH_MODE).setString(hatch.getControlMode().name());
        waltonDashboard.getEntry(MOTORS_INTAKE_OPEN).setBoolean(hatch.getIntakeIsSet());

        waltonDashboard.getEntry(MOTORS_CARGO_ANGLE).setNumber(cargo.getAngle());
        waltonDashboard.getEntry(MOTORS_CARGO_POWER).setNumber(cargo.getRotationPower());
        waltonDashboard.getEntry(MOTORS_CARGO_TARGET).setNumber(cargo.getCurrentTarget());
        waltonDashboard.getEntry(MOTORS_CARGO_MODE).setString(cargo.getControlMode().name());

        waltonDashboard.getEntry(MOTORS_CLIMBER_POWER).setNumber(climber.getClimberPower());
        waltonDashboard.getEntry(MOTORS_CLIMBER_MODE).setString(climber.getClimberControlMode().name());

        waltonDashboard.getEntry(MOTORS_LOWER_LIMIT).setBoolean(elevator.isLowerLimit());

        Faults faults = new Faults();
        elevatorMotor.getFaults(faults);
        waltonDashboard.getEntry(MOTORS_ELEVATOR_ForwardSoftLimit).setBoolean(faults.ForwardSoftLimit);
        waltonDashboard.getEntry(MOTORS_ELEVATOR_ReverseSoftLimit).setBoolean(faults.ReverseSoftLimit);

        clawRotationMotor.getFaults(faults);
        waltonDashboard.getEntry(MOTORS_CLAW_ForwardSoftLimit).setBoolean(faults.ForwardSoftLimit);
        waltonDashboard.getEntry(MOTORS_CLAW_ReverseSoftLimit).setBoolean(faults.ReverseSoftLimit);

        hatchRotationMotor.getFaults(faults);
        waltonDashboard.getEntry(MOTORS_HATCH_ForwardSoftLimit).setBoolean(faults.ForwardSoftLimit);
        waltonDashboard.getEntry(MOTORS_HATCH_ReverseSoftLimit).setBoolean(faults.ReverseSoftLimit);
