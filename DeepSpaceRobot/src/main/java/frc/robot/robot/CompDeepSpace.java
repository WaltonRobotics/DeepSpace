...
import static frc.robot.Robot.waltonDashboard;
...
public class CompDeepSpace extends LimitedRobot {
    ...
    public double getMaxAcceleration() {
        return waltonDashboard.getEntry(CONSTANTS_MAX_ACCELERATION).getNumber(3.0).doubleValue();
    }

    @Override
    public double getMaxVelocity() {
        return waltonDashboard.getEntry(CONSTANTS_MAX_VELOCITY).getNumber(1.5).doubleValue();
    }

    @Override
    public double getKV() {
        return waltonDashboard.getEntry(CONSTANTS_KV).getNumber(0.25).doubleValue();
    }

    @Override
    public double getKAcc() {
        return waltonDashboard.getEntry(CONSTANTS_KACC).getNumber(0.03).doubleValue();
    }

    @Override
    public double getKK() {
        return waltonDashboard.getEntry(CONSTANTS_KK).getNumber(0.01).doubleValue();
    }

    @Override
    public double getKS() {
        return waltonDashboard.getEntry(CONSTANTS_KS).getNumber(0.5).doubleValue();
    }

    @Override
    public double getKAng() {
        return waltonDashboard.getEntry(CONSTANTS_KANGLE).getNumber(1.05).doubleValue();
    }

    @Override
    public double getKL() {
        return waltonDashboard.getEntry(CONSTANTS_KL).getNumber(0.5).doubleValue();
    }
...
//    this.addTarget(HatchPosition.CARGO_START, new Target(-143, -113));
        ...
        this.addTarget(ElevatorLevel.CARGO_BASE, new Target(3365));
