...
//      currentRobot.getLeftTalonConfig().getChannel() + 1);
  ...
  public static final Talon leftIntakeMotor = new Talon(currentRobot.getLeftIntakeMotorConfig().getChannel());
  public static final Talon rightIntakeMotor = new Talon(
  ...
  public static final Solenoid shifter = new Solenoid(PneumaticsModuleType.CTREPCM, SHIFTER_CHANNEL);
  public static final DoubleSolenoid hatchIntake = new DoubleSolenoid
          (PneumaticsModuleType.CTREPCM,HATCH_INTAKE_CHANNEL, HATCH_INTAKE_CHANNEL + 1);
...
//  );
  ...
  public static final Talon climberMotor = new Talon(currentRobot.getClimberMotorConfig().getChannel());
    //possibly Victor
  // "Comp DeepSpace".equals(currentRobot.getRobotName()) ? new Victor(
