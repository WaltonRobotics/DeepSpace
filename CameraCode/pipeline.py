...
class FilterLines:
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_hue = [87.41006998384157, 100.54329175956181]
        self.__hsl_threshold_saturation = [57.32913669064748, 255.0]
        ...
        self.__filter_lines_min_length = 16.0
    ...
    def __find_lines(input):
        ...
        if len(lines) != 0:
            for i in range(1, len(lines[0])):
                tmp = FilterLines.Line(lines[0][i, 0][0], lines[0][i, 0][1],
